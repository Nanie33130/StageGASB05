...
public:
    ...
    QAction *action_A_propos_du_BackOffice;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        action_A_propos_du_BackOffice = new QAction(MainWindow);
        action_A_propos_du_BackOffice->setObjectName(QStringLiteral("action_A_propos_du_BackOffice"));
        ...
        pushButtonSynchro->setEnabled(false);
        ...
        progressBarSynchro->setEnabled(true);
        ...
        menu_A_propos_de = new QMenu(menuBar);
        menu_A_propos_de->setObjectName(QStringLiteral("menu_A_propos_de"));
        ...
        menuBar->addAction(menu_A_propos_de->menuAction());
        menuOtpion->addAction(actionOptions);
        menu_A_propos_de->addAction(action_A_propos_du_BackOffice);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        action_A_propos_du_BackOffice->setText(QApplication::translate("MainWindow", "&A propos du BackOffice", 0));
        ...
        menu_A_propos_de->setTitle(QApplication::translate("MainWindow", "&Infos", 0));
    } // retranslateUi
